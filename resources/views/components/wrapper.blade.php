    ...
    @if($field->hasTableLayout())
        ...
        <x-filament-forms::field-wrapper
            ...
            x-data="searchableInput({
                ...
                tableMode: true,
                columns: @js(collect($field->getColumns())->map(fn($col) => $col->toArray())),
            ...
            x-on:keydown.prevent.enter="selectCurrentOrFirst()"
            x-on:keydown.prevent.esc="showTable = false"
            x-on:keydown.prevent.up="prevIndex()"
            x-on:keydown.prevent.down="nextIndex()"

            x-on:keydown.tab="showTable = false"
        >
            {{$slot}}
